class PrincipalAG {
  ...
  FondosAG fondosag;
  Textos textos;
  BotonesAG botonesG_top, botonesG_bot, botonseguir, botonIzq, botonDer, botonVolver,botonVolverJ;
  ...
  PrincipalAG() {
    ...
    textos = new Textos();
    botonesG_top = new BotonesAG(30, 220, 320, 150, 40); // boton de intro (int tamTxt_, int b_px, int b_py, int b_ancho, int b_alto)
    botonesG_bot = new BotonesAG(30, 220, 380, 150, 40); // boton de intro
    botonIzq = new BotonesAG(18, 175, height-75, 250, 50);
    botonDer = new BotonesAG(18, width-175, height-75, 250, 50);
    botonVolver = new BotonesAG(30, width/2, height-160, 150, 40); // boton en creditos
    botonseguir = new  BotonesAG(0, width/2, height-75, 75, 75); // boton con icono
    botonVolverJ = new BotonesAG(30,width/2, 450, 400, 80);
  ...
  void dibujarPrincipalAG() {
    ...
    if (pantalla == 24 && principaljg.J_pantalla==9) {
     botonVolverJ.d_BTexto(24, 10, "Continuar con la historia");
    }
  }
  ...
  void detec_BotonesAG() {
    ...
    if (botonVolverJ.botonClickear_AG(width/2, 450, 400, 80) && pantalla ==botonVolverJ.partida) {
      pantalla = botonVolverJ.destino;
    }
