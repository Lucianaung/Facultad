...
class Textos {
  ...
  /*7*/    "Con la ilusión de que fuera una mujer, llama específicamente a todos\n los salones de belleza. Hasta que finalmente, en Nueva Texas \natiende Genevieve Selsor. Pero por la caida de un poste, la llamada se corta.", 
  /*8*/    "Llega y se encuentra con el pueblo vacio y sin rastro de Genevive.\n Vuelve a Marlin, su pueblo, con la esperanza de que ella lo haya ido a buscar allí.", 
